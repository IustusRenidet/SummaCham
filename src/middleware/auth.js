...
const JWT_REFRESH_SECRET =
  process.env.PANELAMCHAM_REFRESH_SECRET || `${JWT_SECRET}-refresh`;
...
const emitirTokens = ({ id, usuario }) => {
  ...
  return {
    ...
    tokenRefresco: jwt.sign(base, JWT_REFRESH_SECRET, {
...
const requireAuth = (req, res, next) => {
  try {
    ...
    return res
      .status(status)
      .json({ mensaje: "No se pudo validar la sesión." });
  }
};
